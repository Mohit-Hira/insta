...
def root():
    ...
    if id_token:
        try:
            ...
            print(claims)  # Debugging the claims to see what keys are available
            userid = claims['email']
            password = "pass"
            ...
            if existing_user:
                ...
                entity.update({
                    'username': claims.get('name', claims.get('displayName', 'Guest')),
                    'userid': userid,
                    'password': password,
                    'followers': [],
                    'following': []
            ...
            session['username'] = claims.get('name', claims.get('displayName', 'Guest'))
            print(session)
